...
async def entrypoint(ctx: JobContext):
    initial_ctx = llm.ChatContext().append(
        role="system",
        text=(
            "You are a voice assistant created by Cosmium for Burger Singh. Your interface with users will be voice. "
            "You should use short and concise responses, and avoiding usage of unpronouncable punctuation. "
            "Provide help for people looking to set up a new franchise of Burger Singh."
            "Output in hindi text or english text depending on how the user talks to you."
        ),
    )
    ...
    await agent.say(
        "Hi there, this is Burger Singh, how can I help you today?", allow_interruptions=False
    )
